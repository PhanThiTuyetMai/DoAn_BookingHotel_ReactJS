...
const SuaKhachHang = () => {
    ...
    const KhachData = async () => {
        ...
        try {
                ...
                const response = await API.get(`${endpoints['khachhang']}?ma=${idkh}`, {headers});
    ...
    const suaKhachHang = async () => {
        ...
        try {
            ...
            await API.put(`${endpoints['khachhang']}${idkh}/sua_kh/`, formData, {headers});
